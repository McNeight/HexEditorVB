   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox pctManifest 
         ...
         Begin VB.CheckBox Check13 
            Caption         =   "Activer la coloration de la barre de raccourcis"
            Height          =   255
            Left            =   120
            TabIndex        =   99
            ToolTipText     =   "Active ou non la coloration de la barre de raccourcis (toolbar) de la fenêtre principale"
            Top             =   5400
            Width           =   4455
         End
         Begin VB.PictureBox pctBC 
            BackColor       =   &H00F9E5D9&
            BorderStyle     =   0  'None
            Height          =   200
            Left            =   2400
         ...
         Begin VB.Label Label3 
            Caption         =   "Couleur de fond des menus : "
            Height          =   255
            Left            =   120
            TabIndex        =   98
            Top             =   5040
         ...
         Begin VB.Label Label2 
            Caption         =   "Couleur de fond de fenêtre :"
            Height          =   255
            Left            =   120
            TabIndex        =   96
            Top             =   4680
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.ComboBox cbExpInitDir 
            Height          =   315
            ItemData        =   "frmOptions.frx":06E3
            Left            =   2520
            List            =   "frmOptions.frx":06ED
            Style           =   2  'Dropdown List
            TabIndex        =   6
            Tag             =   "lang_ok"
         ...
         Begin VB.TextBox txtExpPath 
            ...
            TabIndex        =   3
            Text            =   "C:\"
            ToolTipText     =   $"frmOptions.frx":0711
            Top             =   4680
            Width           =   2535
         End
         Begin VB.CheckBox chkEx 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.ComboBox cbOS 
            Height          =   315
            ItemData        =   "frmOptions.frx":0854
            Left            =   2040
            List            =   "frmOptions.frx":085E
            Style           =   2  'Dropdown List
            TabIndex        =   57
         ...
         Begin VB.ComboBox cbLang 
            Height          =   315
            ItemData        =   "frmOptions.frx":0891
            Left            =   2040
            List            =   "frmOptions.frx":0898
            Style           =   2  'Dropdown List
            TabIndex        =   56
...
Dim s As String
    ...
    With HW
        ...
        pctBC.BackColor = 16377305
        pctMenu.BackColor = 16117739
    End With
...
Dim s As String
    ...
    'affecte à cPref toutes ses valeurs
        With cPref
            ...
            .general_FormBackColor = pctBC.BackColor
            .general_MenuBackColor = pctMenu.BackColor
            .general_ToolbarPCT = Check13.Value
    ...
    'change la couleur des menus de frmContent
...
Dim s As String
    ...
    '//LECTURE DES PREFERENCES
        ...
        With cPref
            ...
            pctBC.BackColor = .general_FormBackColor
            pctMenu.BackColor = .general_MenuBackColor
        ...
        With cPref
            ...
            Check13.Value = .general_ToolbarPCT
