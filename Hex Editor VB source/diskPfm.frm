...
Dim r As Long
    ...
    'popup menu
    If Button = 2 Then
        frmContent.mnuDelete.Enabled = False
        frmContent.mnuPopupCut.Enabled = False
        Me.PopupMenu frmContent.mnuPopupGrid ', X + GD.Left, Y + GD.Top
    End If
...
Dim I_tem As ItemElement
    ...
    DirectWriteS cDrive.VolumeLetter & ":\", Sector, lBytesPerSector, lBytesPerSector, sActualString
